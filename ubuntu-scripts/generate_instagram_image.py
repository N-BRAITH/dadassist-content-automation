...
def main():
    ...
    if len(sys.argv) < 2:
        print("Usage: python3 generate_instagram_image.py 'Article Title' ['Custom Filename']")
        print("Example: python3 generate_instagram_image.py 'Property Settlement Guide' 'custom_name.jpg'")
        return None
