    ...
    if skip_generation:
        ...
        html_content += f"""
            ...
            <div class="success-box">
                ...
                <ul>
                <li>Twitter: ✅ Success - https://twitter.com/dad_assist/status/123</li>
                <li>Facebook: ✅ Success - https://facebook.com/DadAssist/posts/456</li>
                <li>Instagram: ❌ Failed - Token expired</li>
                </ul>
            </div>"""
